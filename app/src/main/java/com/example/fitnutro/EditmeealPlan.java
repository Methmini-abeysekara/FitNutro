...
public class EditmeealPlan extends AppCompatActivity {
    ...
    private EditText editmealplanname,editmenuedit3,editmenuedit2,editmenuedit1,editeditTextTextPersonName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editmenuedit2=findViewById(R.id.m_editmenuedit2);
        ...
        editaddmealplan2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Mealplanmodal mealplanmodal =new Mealplanmodal(Integer.parseInt(id),
                        ...
                        editmenuedit2Text,editmenuedit3Text,updateDate,0);
