...
public class Mealplanmodal {
    private int id;
    private String name,description,menus_1,menus_2,menus_3;
    ...
    public Mealplanmodal(int id,String name,String description,String menus_1,String menus_2,String menus_3,long started,long finished) {
        this.id = id;
        this.name = name;
    ...
    public Mealplanmodal(String name,String description,String menus_1,String menus_2,String menus_3,long started,long finished) {
